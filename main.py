...
def attack(char_name: str, char_class: str) -> str:
    """Show informational messages about attack."""
    ...
    return 'У Вашего класса нет разновидностей атак'


def defence(char_name: str, char_class: str) -> str:
    """Show informational messages about protection."""
    if char_class == 'warrior':
    ...
    return 'У Вашего класса нет разновидностей защиты'


def special(char_name: str, char_class: str) -> str:
    """Show informational messages about using a special ability."""
    if char_class == 'warrior':
        return (
    ...
    return 'У Вашего класса нет супер-способности'


def start_training(char_name: str, char_class: str) -> str:
    """Analyze the selected type of attack."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Get the character class from the user and return it."""
